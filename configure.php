...
foreach ($files as $file) {
    ...
    match (true) {
        ...
        str_contains($file, determineSeparator('src/LivewirePasswordMeterServiceProvider.php')) => rename($file, determineSeparator('./src/'.$className.'ServiceProvider.php')),
        ...
        str_contains($file, determineSeparator('config/livewire-password-meter.php')) => rename($file, determineSeparator('./config/'.$packageSlugWithoutPrefix.'.php')),
